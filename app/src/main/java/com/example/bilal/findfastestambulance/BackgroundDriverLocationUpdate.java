...
public class BackgroundDriverLocationUpdate extends AsyncTask<String,Void,Void>{
    String result =null;
    @Override
    protected Void doInBackground(String... params) {
        try
        {
            HttpURLConnection httpURLConnection = new HttpConnection(new URL_genrator().getDriverlocationInsertionUrl()).returnconnection();
